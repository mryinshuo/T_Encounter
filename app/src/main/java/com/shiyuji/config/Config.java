...
public class Config {
    ...
    public static final String STSSERVER = "http://192.168.1.54:7080/";//STS 地址

    public static final String uploadFilePath = "video/"; //本地文件上传地址
    public static final String bucket = "ys-bucket123";
